...
<ul class="breadcrumb">
    ...
    <li class="active"> จำนวนหญิงตั้งครรภ์ที่ได้รับการฝากครรภ์ แฟ้ม (HDC 43 แฟ้ม) <span class='badge alert-danger'>แฟ้ม Anc </span></li>
</ul>
...
<script src="<?php echo base_url()?>assets/apps/js/mom.anc.js" charset="utf-8"></script>
