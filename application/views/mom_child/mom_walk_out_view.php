...
<ul class="breadcrumb">
    ...
    <li><a href="<?php echo site_url()."/mom/"?>">แม่และเด็ก</a></li>
    <li class="active"> หญิงตั้งครรภ์ที่ไปรับบริการฝากครรภ์ที่อื่น <span class='badge alert-danger'>แฟ้ม Anc </span></li>
</ul>
...
<script src="<?php echo base_url()?>assets/apps/js/mom.mom_walk_out.js" charset="utf-8"></script>
