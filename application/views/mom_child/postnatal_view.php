...
<ul class="breadcrumb">
    ...
    <li class="active"> จำนวนหญิงตั้งครรภ์ (HDC 43 แฟ้ม) ที่ได้รับการเยี่ยมหลังคลอด <span class='badge alert-danger'>แฟ้ม Postnatal </span></li>
</ul>
...
<script src="<?php echo base_url()?>assets/apps/js/mom.postnatal.js" charset="utf-8"></script>
