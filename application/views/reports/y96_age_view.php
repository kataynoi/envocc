...
<ul class="breadcrumb">
    ...
    <li class="active">จำนวนผู้ป่วยด้วยโรคจากการประกอบอาชีพตามกลุ่มอายุ</li>
</ul>
    ...
    <div class="col-lg-12">
        <div class="panel panel-success">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-fax fa-fw"></i> จำนวนผู้ป่วยด้วยโรคจากการประกอบอาชีพ ตามกลุ่มอายุ</h3>
            </div>
...
<script src="<?php echo base_url()?>assets/apps/js/report.y96_age.js" charset="utf-8"></script>
