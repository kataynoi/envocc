...
<ul class="breadcrumb">
    ...
    <li class="active">จำนวนผู้ป่วยด้วยโรคจากสิ่งแวดล้อม</li>
</ul>
    ...
    <div class="col-lg-12">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-fax fa-fw"></i> จำนวนผู้ป่วยด้วยโรคจากสิ่งแวดล้อม </h3>
            </div>
...
<table class="table table-responsive table-hover table-bordered" id='tbl_list'>
        <thead>
        <tr>
            <th rowspan="2">#</th>
            <th rowspan="2">ชื่อหน่วย</th>
            <th colspan="3">จำนวน ผู้ได้รับการวนิฉัยด้วย Y97</th>
        </tr>
        <tr>
            <th> ชาย </th>
            <th> หญิง </th>
...
<script src="<?php echo base_url()?>assets/apps/js/report.y97.js" charset="utf-8"></script>
