...
<ul class="breadcrumb">
    ...
    <li><a href="<?php echo site_url()."/thaimed/"?>">ทันตกรรม </a></li>
    <li class="active"> ข้อมูลการให้บริการหัตถการทันตกรรม </li>
</ul>
...
<script src="<?php echo base_url()?>assets/apps/js/dental.procedure.js" charset="utf-8"></script>
