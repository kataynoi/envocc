<nav role="navigation" class="navbar navbar-default navbar-fixed-top">
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
        <form action="#" class="navbar-form navbar-left">
            <label for="">รหัสสถานบริการ </label>
            <input type="text" class="form-control" style="width: 160px;" value="<?php echo $off_id?>"
                   id="txt_off_id" disabled />
            <label for="">ชื่อสถานบริการ </label>
            <input type="text" class="form-control" style="width: 200px;" value="<?php echo $off_name?>"
                   id="txt_off_name" disabled />
            <label for="">Lat</label>
            <input type="text" class="form-control" style="width: 200px;"
                   id="txt_lat" value="<?php echo $office_lat;?>"  />
            <label for="">Lng</label>
            <input type="text" class="form-control" style="width: 200px;"
                   id="txt_lng" value="<?php echo $office_lng;?>"  />
...
<script src="<?php echo base_url()?>assets/apps/js/set_map_office.js" charset="utf-8"></script>
