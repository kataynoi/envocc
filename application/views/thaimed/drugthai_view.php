...
<span> ปีงบประมาณ
        ...
        <div class="btn-group">
            <button type="button" class="btn btn-primary" data-name="btn_show_drugthai">
...
<script src="<?php echo base_url()?>assets/apps/js/thaimed.drugthai.js" charset="utf-8"></script>
