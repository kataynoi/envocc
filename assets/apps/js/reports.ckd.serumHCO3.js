    ...
    reports.set_control_bp = function (data) {
        $('#tbl_list > tbody').append(
            '<tr>' +
                ...
                '<td>' + app.add_commars_with_out_decimal(data.ckd_tco2) + '</td>' +
                '<td>' + app.add_commars_with_out_decimal(data.ckd_tco2_ok) + '</td>' +
                '<td>' + app.add_commars_with_out_decimal(data.ckd_tco2_not_ok) + '</td>' +
                '</tr>'
        );
