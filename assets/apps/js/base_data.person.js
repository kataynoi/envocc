$(document).ready(function(){
    ...
    var person = {};
    person.ajax = {
        get_person_by_amp: function (items, cb) {
            var url = '/base_data/get_person_by_amp',
                params = {
                    items: items
                }
    ...
    person.get_person_by_amp = function(items){
        ...
        person.ajax.get_person_by_amp(items, function (err, data) {
    ...
    $(document).on('click', 'button[data-name="btn_show_person"]', function(e) {
        ...
        person.get_person_by_amp(items);
