$(document).ready(function(){
    ...
    vaccine.ajax = {
        ...
        },get_vaccine_hospcode: function (items,start,stop, cb) {
            var url = '/epi/get_vaccine',
                params = {
                    items: items,
                    start:start,
        ...
        },get_vaccine_total: function (items, cb) {
            var url = '/epi/get_vaccine_total',
                params = {
                    items: items
                }
    ...
    vaccine.get_vaccine_hospcode=function(items){
    ...
    vaccine.get_vaccine = function(items){
        $('#tbl_list > tbody').empty();
