    ...
    reports.set_control_bp = function (data) {
        $('#tbl_list > tbody').append(
            '<tr>' +
                ...
                '<td>' + app.add_commars_with_out_decimal(data.ckd_po4) + '</td>' +
                '<td>' + app.add_commars_with_out_decimal(data.ckd_po4_ok) + '</td>' +
                '<td>' + app.add_commars_with_out_decimal(data.ckd_po4_not_ok) + '</td>' +
                '</tr>'
        );
