    ...
    reports.set_control_bp = function (data) {
        $('#tbl_list > tbody').append(
            '<tr>' +
                ...
                '<td>'+ app.add_commars_with_out_decimal(data.ckd_upcr)+'</td>' +
                '<td>' + app.add_commars_with_out_decimal(data.ckd_upcr_ok) + '</td>' +
                '<td>' + app.add_commars_with_out_decimal(data.ckd_upcr_not_ok) + '</td>' +
                '</tr>'
        );
