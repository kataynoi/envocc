    ...
    reports.set_control_bp = function (data) {
        $('#tbl_list > tbody').append(
            '<tr>' +
                ...
                '<td>' + app.add_commars_with_out_decimal(data.ckd_recieve_drug) + '</td>' +
                '<td>' + app.add_commars_with_out_decimal(data.ckd_not_recieve_drug) + '</td>' +
                '</tr>'
        );
